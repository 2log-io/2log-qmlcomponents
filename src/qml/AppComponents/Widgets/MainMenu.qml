...
ColumnLayout {
    ...
    HeaderButton {
        ...
        icon: Icons.products
        selected: stackView.depth > 0 && stackView.currentItem
                  !== null ? stackView.currentItem.viewID === "products" : false
        onClicked: {
    ...
    HeaderButton {
        ...
        text: qsTr("Kasse")
        visible: root.width > 1000
                 && (UserLogin.currentUser.userData
                     === undefined ? false : UserLogin.currentUser.userData.role !== "mngmt")
        icon: Icons.payDesk
        selected: stackView.depth > 0 && stackView.currentItem
                  !== null ? stackView.currentItem.viewID === "paydesk" : false
        onClicked: {
