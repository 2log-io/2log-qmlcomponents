...
Container {
    ...
    property bool allOkay: pow.available && pow.deviceOnline && reader.available
                           && reader.deviceOnline
            ...
            BaseValueBox {
                ...
                Row {
                    ...
                    Icon {
                        ...
                        iconColor: !controller.getProperty(
                                       "enabled").value ? Colors.warnRed : Colors.white_op50
                    }

                    ToggleSwitch {
                        checkable: false
                        Binding on checked {
                            value: controller ? controller.getProperty(
                                                    "enabled").value : false
                        }
                        ...
                        anchors.verticalCenter: parent.verticalCenter
                        onClicked: controller.getProperty(
                                       "enabled").value = !controller.getProperty(
                                       "enabled").value
                    }
                    ...
                    Icon {
                        ...
                        icon: Icons.lockOpen
                        iconColor: controller.getProperty(
                                       "enabled").value ? Colors.highlightBlue : Colors.white_op50
                    }
