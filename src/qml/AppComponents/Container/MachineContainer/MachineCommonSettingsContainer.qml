...
Container
{
    ...
    Item
    {
        ...
        function save()
        {
            ...
            if(suction.dirty)
            {
                ...
                model.suction = suctionModel.getModelAt(suction.editedSelectedIndex-1).deviceID
            }
    ...
    Form
    {
        ...
        FormTextItem
        {
            ...
            id: autoOff
            Binding on text {value:model ?  model.idleTimeTimeout / 1000 / 60 : ""}
        ...
        FormDropDownItem
        {
            ...
            selectedIndex: model ?  TypeDef.getIndexOf(TypeDef.machineType, model.tag) : 0
        }
        ...
        FormCheckItem
        {
             ...
             checked: model && model.dependsOnSuction !== undefined ? model.dependsOnSuction : false
        }
    }
