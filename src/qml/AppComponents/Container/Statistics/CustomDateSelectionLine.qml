...
Flow
{
    ...
    function setText(from, to)
    {
        ...
        var todayFrom = Qt.formatDateTime(from, "dd.MM.yyyy") == Qt.formatDateTime(new Date(), "dd.MM.yyyy")
        ...
        else
        {
            ...
            headlineB.text = "<a href=\"fromDate\">" + Qt.formatDateTime(from, "dd.MM.") + "</a>"
        }
        ...
        var todayTo = Qt.formatDateTime(to, "dd.MM.yyyy") == Qt.formatDateTime(new Date(), "dd.MM.yyyy")
        if(todayTo)
        {
        ...
        {
            headlineF.text = "<a href=\"toDate\">"+ Qt.formatDateTime(to, "dd.MM.")+ "</a> "//++"  bis jetzt"
            headlineE2.visible = true
        }
