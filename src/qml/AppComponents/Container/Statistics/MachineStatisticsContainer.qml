    ...
    Flow {
        ...
        TimeValueBox {
            ...
            TextLabel {
                ...
                opacity: .4
                text: {
                    if (lastMaintainance.initialized
                            && lastMaintainance.reset !== undefined) {
                        return qsTr("Seit dem %1").arg(
                                    Qt.formatDate(lastMaintainance.reset,
                                                  "dd.MM.yy"))
                    } else
                        return ""
                }
        ...
        ValueBox {
            ...
            value: {
                if (model.initialized) {
                    return model.revenue >= 0 ? (model.revenue / 100).toLocaleString(
                                                    Qt.locale("de_DE")) : 0
                }
                return ""
            }
