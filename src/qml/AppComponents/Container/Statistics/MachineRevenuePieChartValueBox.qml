...
BaseValueBox
{
    ...
    GridLayout
    {
        ...
        Item
        {
            ...
            PieChart
            {
                ...
                anchors.margins: 20
                model: docroot.model
                onItemHovered: if(index >= 0) list.currentIndex = index
                visible: total > 0
                    ...
                    Row
                    {
                        ...
                        TextLabel
                        {
                            ...
                            text:
                            {
                                ...
                                {
                                    unitLabel.text = "%"
                                    return ((piChart.model[idx].value / piChart.total) * 100 ).toFixed(2)
                                }
                                else
                                {
                                    unitLabel.text = "EUR"
                                    return (piChart.total / 100).toLocaleString(Qt.locale("de_DE"))
                                }
                                return ""
                            }
                        }
                ...
                Item
                {
                    ...
                    RowLayout
                    {
                        ...
                        TextLabel
                        {
                            ...
                            Layout.fillWidth: true
                            color: index == piChart.hoveredIndex ? Colors.highlightBlue : Colors.white
                        ...
                        TextLabel
                        {
                            ...
                            Layout.alignment: Qt.AlignVCenter
                            text: (modelData.value / 100).toLocaleString(Qt.locale("de_DE"))+"€"
                        }
                    }
    ...
    Column
    {
        ...
        TextLabel
        {
            text: piChart.total == 0 && list.count > 0 ?  qsTr("Keine Umsätze") : qsTr("Keine Daten")
