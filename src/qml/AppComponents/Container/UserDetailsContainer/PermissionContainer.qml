...
Container
{
    ...
    Item
    {
        height: 150
        width: parent.width
        property bool loading:!groupModel.initialized || !allgroupsModel.initialized || !permModel.initialized //|| !deviceModel.initialized
        Behavior on height {NumberAnimation{easing.type: Easing.OutQuad; duration: 300}}
        onLoadingChanged: if(!loading) timer.running = true
        ...
        Timer
        {
            ...
            onTriggered:
            {
                parent.height = Qt.binding(function(){return column.height})
        ...
        Column
        {
            ...
            DynamicGridView
            {
                ...
                cellHeight: 150
                maxCellWidth: 160
                model: container.userID !== "" && allgroupsModel.count !== 0 ?  allgroupsModel.keys : 0
                ...
                Item
                {
                    ...
                    GroupPermissionItem
                    {
                        ...
                        expires: groupModel.getItem(modelData).expirationDate !== undefined ? groupModel.getItem(modelData).expirationDate : ""
            ...
            DynamicGridView
            {
                ...
                model:  container.userID !== "" && groupModel.initialized ?  deviceModel : 0
                ...
                Item
                {
                    ...
                    SinglePermissionItem
                    {
                        ...
                        anchors.bottomMargin: 10
                        anchors.rightMargin:  10
                        hasGroupPermission: {container.bindingHelper; container.check(_deviceID)}
                        deviceName:  _displayName
                        onSetLevel: setPermission(_deviceID, level)
                        expires: parent.permissionData.expirationDate !== undefined ? parent.permissionData.expirationDate : ""
                        permissionState:
                        {
                        ...
                        iconImage:TypeDef.getMachineIconSource(deviceModel.getDeviceModel(_deviceID).tag)
                        onClicked: setPermission(_deviceID, (permissionState+1) % 3)
                        onDateSelected:
                        {
