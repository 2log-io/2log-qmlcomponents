...
BaseItem {
    ...
    Row {
        ...
        RadioGroupButton {
            ...
            onClicked: if (permissionState == 1)
                           docroot.clicked()
            toolTipText: permissionState == 1 ? qsTr("Gruppenberechtigung entziehen") : qsTr(
                                                    "Keine Berechtigung")
        }
        ...
        RadioGroupButton {
            ...
            onClicked: if (permissionState == 0)
                           docroot.clicked()
            toolTipText: permissionState == 0 ? qsTr("Gruppenberechtigung erteilen") : qsTr(
                                                    "Gruppenberechtigung erteilt")
        }
    }
